...
raw_data_table = "ItemDataRawRecord"
...
def home():
    return render_template('interface_v3_home_relativity.html')
...
def login():
    ...
    return render_template("interface_v3_relativity.html",UserName = username,UserID = userid,
...
def log():
    ...
    max_record = db.selectmax(raw_data_table,columns,where_dic)
    if max_record == None:
        log_dic["UserRecordID"] = str(0)
    else:
        log_dic["UserRecordID"] = str(max_record + 1)
