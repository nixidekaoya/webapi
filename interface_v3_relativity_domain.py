...
def home():
    return render_template('interface_v3_home_relativity_domain.html')
...
def login():
    ...
    return render_template("interface_v3_relativity_domain.html",UserName = username,UserID = userid,
